class PhysiciansController < ApplicationController
  ...
  private
    ...
    def physician_params
      params.require(:physician).permit(:name, :specialty, offices_attributes: [:id, :streetaddress, :zip, :phone, :done, :_destroy], appointmentts_attributes: [:id, :visit, :physician_id, :patient_id, :_destroy])
    end
end
